...
// The General Functionality and Function Calling Method ------------------------------------------------
$(document).ready(function () {
    ...
    initInversiones(inversiones, function () {
        console.log('Investments loaded successfully');
    });

    setUser(0, function () {
        console.log("visitor user loaded successfully")
    });
...
function initInversiones(inversiones, callback) {
...
function changeUser() {
    ...
    $.each(users, function (index, value) {
        if (changeUsername == value[0].username) {
            found = true;
            foundIndex = index;
            changeID = users[foundIndex].id;
            truePass = users[foundIndex].contra;
            return true;
        }
    })
    ...
    if (found == true && passRight == true) {
        setUser(foundIndex, function () {
            console.log("Next user set successfully");
        });
    } else {
